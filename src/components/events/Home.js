...
_rObj_m(par){
  ...
  render() {
    ...
    if(this.state.big_screen){
      ...
      return (
          ...
          <div style={{width:"100%",padding:'0px',  textAlign:"center", overflowX: "hidden"}}>
              <Sidebar {...this.props} style={{ margin:'-55px 0 0 0 !important'}} />
          <main className="main">

            <Container fluid style={{padding: "80px 30px 0px 30px"}}>
              <div className="animated fadeIn">



              <Row style={{width:"100%", marginTop:"20px",height:"100px"}}>
   ...
   <div style={{width:"100%", padding: "0px",textAlign:"center", height:"1000px"}}>
       <Row style={{margin:"0px 10px", minHeight:"1000px" }}>
           ...
           {this.state.course_details_view?(<Col xs="12" sm="12" lg="12" style={{width:"100%", fontSize:"2.8rem", padding:"20px 0px", color:"#000000", fontWeight:"500"}}>
               {this.state.viewCart ?
                   (
                       <div style={{width:"95%", minHeight:"1000px",borderRadius:"10px", margin:"0 auto", background:"#fff", paddingTop:"20px"}}>
      ...
      return (
                            ...
                            <Col xs="12" sm="12" lg="12" style={{padding:"5px", marginTop:"80px", textAlign:"center"}} >
                                ...
                                <FormGroup style={{padding:"0 10px",  margin:"0 auto"}}>
                                                   ...
                                                   <Input
                                                     ...
                                                     onChange={evt => this.updateInput(evt)}
                                                   />
                                                   <div style={{ width:"100%", padding:"5px 0px", fontWeight:"1000", fontSize:"1.4rem", color:"#999999", textAlign:"left"}} >
       ...
       <div style={{width:"100%", padding: "0px 0px",padding:'0', textAlign:"center", height:"1000px"}}>
           <Row style={{margin:"0px" }}>
               ...
               {this.state.course_details_view?(<Col xs="12" sm="12" lg="12" style={{width:"100%", fontSize:"2.8rem", padding:"2px 0px", color:"#000000", fontWeight:"500"}}>
                   ...
                   <Col  xs="12" sm="12" lg="12" style={{padding:"0px 2px"}}>
                       <Row style={{width:"100%" , background:"#fff", borderRadius:"1px", margin:"0 auto", padding:"3px 2px 2px 2px", minHeight:"1000px"}}>
                    ...
                    {this.state.viewCart?(null):(
                        <Row style={{width:"100%" , borderRadius:"10px", margin:"0 auto", padding:"3px 0px 2px 0px", minHeight:"1000px"}}>
